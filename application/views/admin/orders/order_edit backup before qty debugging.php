                  ...
                  <div class="form-group col-md-6">
                    ...
                    <select class="form-control" id="item-name">
                      ...
                      ?>
                        ...
                        <option value="<?php echo $single_item['id']; ?>"><?php echo $single_item['Name']; ?></option>
