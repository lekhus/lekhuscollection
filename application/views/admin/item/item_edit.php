      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open_multipart(base_url('admin/item/edit/'.$item['id']), 'class="form-horizontal"' )?> 
            ...
            <img src="<?php echo $item['img']!=null?base_url($item['img']):'#'; ?>" id="icon-preview" alt="image" style="width:100px; height:auto;" />
          </div>
