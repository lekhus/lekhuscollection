    ...
    <div class="card">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"><i class="fa fa-list"></i>&nbsp; Design List</h3>
        </div>
        <div class="d-inline-block float-right">
          ...
          <a href="<?= base_url('admin/design/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add New Design</a>
        </div>
      </div>
    </div>
    <div class="card">
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": true,
    "ajax": "<?=base_url('admin/design/datatable_json')?>",
    "order": [[0,'desc']],
    "columnDefs": [
