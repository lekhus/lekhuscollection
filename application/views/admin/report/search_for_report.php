    ...
    <div class="card">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"><i class="fa fa-list"></i>&nbsp; Generate Report</h3>
        </div>
        ...
        <div class="container pt-4">
            ...
            <div class="search-form">
                <?php echo form_open(base_url('admin/report/orderReport'), ['method' => 'get'], 'class="form-horizontal"');  ?> 
    
                  <div class="form-group">
                    <label for="exampleFormControlSelect1">Order report by brand name</label>
                    <select class="form-control" id="brand-name" name="brand-name">
                  ...
                  <div class="form-group">
                      ...
                      <input type="submit" value="Download Order Report" class="btn btn-info pull-left">
            ...
            <!--search with name form starts-->
                    <div class="search-form">
                        <?php echo form_open(base_url('admin/report/salesReport'), ['method' => 'get'], 'class="form-horizontal"');  ?> 
            
                          <div class="form-group">
                            <label for="exampleFormControlSelect1">Sales report by brand name</label>
                            <select class="form-control" id="brand-name" name="brand-name">
                            <?php foreach($brands as $brand){ ?>
                              <option value="<?php echo $brand['Name']; ?>"><?php echo $brand['Name']; ?></option>
                            <?php } ?>
                          ...
                          <div class="form-group">
                              <input type="submit" value="Download Sales Report" class="btn btn-info pull-left">
                          </div>
