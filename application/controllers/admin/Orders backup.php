...
// 		var_dump($records); die;
		...
		{  
			...
			$data[]= array(
				...
				'<a title="View" class="view btn btn-sm btn-info" href="'.base_url('admin/CustomerOrder/getCustomerOrderData?o_id='.$row['order_no']). '&c_id='.$customer['id'] .'"> <i class="fa fa-eye"></i></a>
